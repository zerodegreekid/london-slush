...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      // Get secrets from environment - CORRECT way for Module Workers
      ...
      if (!clientEmail || !privateKey || !sheetId) {
        ...
        return new Response(JSON.stringify({ 
          success: false, 
          error: 'Worker not configured properly. Missing: ' + 
      ...
      const syncSuccess = await appendToGoogleSheet(accessToken, sheetId, rowData);
